	...
	<section id="home">
		...
		<div class="col-xs-12" style="text-align: center; margin: 20px 0;">
			<div class="container">
				...
				<p>
					Para casos de fiestas, eventos y entornos de obras, muchas organizaciones o emprendedores buscan baños químicos en alquiler. Así, pagando un valor fijo por su uso eventual, evitan erogar capital para tener estos recursos como un activo propio, e invertir en ellos de manera permanente.
					<br><br>
					Ecosan ofrece el alquiler de baños químicos en óptimas condiciones. Estos sanitarios portátiles se caracterizan por ser confortables y modernos, y tienen toda una serie de detalles a nivel de terminaciones que los convierten en opciones muy adecuadas para resolver necesidades de baños en lugares abiertos.
					<br><br>
					Por su autonomía y gran capacidad, resultan cómodos y prácticos para su uso. Además, los sanitarios Ecosan están acompañados de un óptimo esquema de mantenimiento, ofreciendo un servicio muy eficaz para reuniones al aire libre con gran cantidad de concurrentes, o para campamentos de trabajo u obras en construcción donde se le debe dar una respuesta sana y eficaz a los trabajadores.
					<br><br>
					Recurrir al alquiler de baños químicos es una práctica cada día más frecuente entre los organizadores de conciertos y recitales, ferias, actos culturales, políticos o eventos de toda índole. Estas unidades portátiles disponen de tanques herméticos y cuentan además con soluciones químicas eficaces que ayudan a digerir el contenido y evitar en todo momento el mal olor. De acuerdo al tipo y modelo del tanque, esta solución química –que es segura y biodegradable- se puede llegar a utilizar entre 50 y 160 veces, aproximadamente, antes de requerir su recambio.
					<br><br>
					Desde el punto de vista de su constitución, los baños químicos son unidades plásticas prefabricadas, livianas y transportables que disponen de puerta con cierre del tipo libre/ocupado. Naturalmente a la hora de evaluar el alquiler de baños químicos hay que pensar que sus precios varían en función de las prestaciones de los mismos, ya que en el mercado se ofrecen unidades de muy diverso porte y capacidad. Partiendo de módulos básicos, también contamos con unidades completas que permiten por ejemplo, disponer de agua caliente, la cual se ofrece en una bacha especialmente concebida para ese servicio, entre otros detalles.
					<br><br>
