          ...
          <div class="col-sm-6 col-md-4">
            <ul>
              ...
              <li class="contact-item">
                <img src="/assets/images/call.svg" alt="0810 444 2266"
                     class="icon" />
                0810 444 2266
              </li>
              <li class="contact-item">
                <img src="/assets/images/phone.svg" alt="0810 444 2266"
                     class="icon" />
                11 4846 0995
              </li>
      ...
      <div class="col-sm-12 branches-header">
        <div class="col-sm-12 found-branches-container">
          ...
          <a data-bs-toggle="collapse" href="#collapseExample" role="button"
             ...
             class="collapsed">
            <img src="/assets/images/marker.svg" alt="Encontra tu Oficina"
                 class="icon" />
        ...
        <div class="col-sm-12 copyright">
          <a href="https://wa.me/5491127505050?">
            <img src="/assets/images/whatsapp.svg" alt="Whatssapp"
                 class="whatsapp" /> </a>
