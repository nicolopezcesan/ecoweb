<section class="asesor-red-bg">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-sm-8 red-text">
        ...
        <div class="row">
          <div class="col-sm-12 red-asesor-container">
            ...
            <h3 class="red-asesor-subtitle"> Ofrecemos productos y servicios que
              ...
              construcción en su constante crecimiento y expansión.</h3>
          </div>
        </div>

        <div class="row">
          <div class="col-sm-12 asesor-container">
      ...
      <div class="col-sm-4">
        <div class="row">
          <div class="col-sm-6 asesor-woman">
            <img class="red-woman" src="/assets/images/woman-red-asesor.png">
          </div>
        </div>
      </div>
    </div>
